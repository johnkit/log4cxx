...
public:
        ...
        void test3() {
                ...
                const logchar fname[] = { static_cast<logchar>(0x6F),
                                          static_cast<logchar>(0x75),
                                          static_cast<logchar>(0x74),
                                          static_cast<logchar>(0x70),
                                          static_cast<logchar>(0x75),
                                          static_cast<logchar>(0x74),
                                          static_cast<logchar>(0x2F),
                                          static_cast<logchar>(0x64),
                                          static_cast<logchar>(0x6F),
                                          static_cast<logchar>(0x6D),
                                          static_cast<logchar>(0xC2),
        ...
        void test4() {
                ...
                const logchar fname[] = { static_cast<logchar>(0x6F),
                                          ...
                                          static_cast<logchar>(0x6F),
                                          static_cast<logchar>(0x6D),
                                          static_cast<logchar>(0xE3),
                                          static_cast<logchar>(0x86),
                                          static_cast<logchar>(0x95),
                                          0 };
#else
                const logchar fname[] = { static_cast<logchar>(0x6F),
                                          static_cast<logchar>(0x75),
